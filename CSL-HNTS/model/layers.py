...
class ChebGraphConv(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.Ks - 1 < 0:
            ...
            x_0 = x
            x_1 = torch.einsum('hi,btij->bthj', self.gso.float(), x.float())
            x_list = [x_0, x_1]
        ...
        cheb_graph_conv = torch.einsum('btkhi,kij->bthj', x.float(), self.weight)
...
class STConvBlock(nn.Module):
    ...
    def __init__(self, Kt, Ks, n_vertex, channels, act_func, graph_conv_type, gso, bias, droprate):
...
class OutputBlock(nn.Module):
    ...
    def __init__(self, Ko, last_block_channel, channels, end_channel, n_vertex, act_func, bias, droprate):
        ...
        self.tmp_conv1 = TemporalConvLayer(6, last_block_channel, channels[0], n_vertex, act_func)
